...
class SUN397Dataset(Dataset):
    def __init__(self, 
                 root: str,           # /data/xiaomeng/dataset/SUN397/
                 txt_file: str,       # Training_01.txt 
                 mapping_dict: dict,  #  get_sun397_mapping 
                 is_train: bool = True,
        ...
        self.img_path = []
        self.fine_labels = []   # L1: 0-396
        self.mid_labels = []    # L2: 0-15
        self.coarse_labels = [] # L3: 0-2
        ...
        with open(txt_file, 'r', encoding='utf-8') as f:
            for line in f:
                ...
                if class_name in mapping_dict:
                    fine_id, mid_id, coarse_id = mapping_dict[class_name]
    ...
    def __getitem__(self, index):
        ...
        if self.is_hier:
            return sample, segments, self.fine_labels[index], self.mid_labels[index], self.coarse_labels[index]
        else:
