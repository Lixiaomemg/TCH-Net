...
from engine_hier import train_one_epoch, evaluate#==================1204======================
from engine_hier_eval_yuan import evaluate_detail
from losses import DistillationLoss
from samplers import RASampler
from augment import new_data_aug_generator

# import cast_models.cast_deit_hier 
# import cast_models.cast_deit_hier_cong
# import cast_models.cast_deit_hier_new
# import cast_models.cast_deit_hier_new_V1
import cast_models.cast_deit_hier_yuan
import utils
...
def get_args_parser():
    ...
    parser.add_argument('--ortho_weight', default=0.05, type=float)
...
def main(args):
    ...
    # hierarchy_map_data = hierarchy_map(args=args)#===================hierarchy_map==============
    # fine_clip_embeds,coarse_clip_embeds = Prototype_initialization()#===================clip_emb==============
    if args.distributed:
    ...
    model = create_model(#=======================模型================================
        ...
        # hierarchy_map = hierarchy_map_data,
        # clip_embeds = fine_clip_embeds,
        # coarse_clip_embeds = coarse_clip_embeds
    )
    print(model)
    for name, param in model.named_parameters():#================================NAN================
