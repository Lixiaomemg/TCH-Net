...
from engine_hier_eval_yuan_pl_th import evaluate_detail
from losses import DistillationLoss
from samplers import RASampler
from augment import new_data_aug_generator


import cast_models.cast_deit_hier_new_0223V2_hcast
...
def get_args_parser():
    ...
    parser.add_argument('--data-set', default='BIRD-HIER-SUPERPIXEL', choices=['AIR-HIER-SUPERPIXEL', 'BIRD-HIER-SUPERPIXEL', 'BREEDS-HIER-SUPERPIXEL',
                                                                'INAT18-HIER-SUPERPIXEL', 'INAT21-MINI-HIER-SUPERPIXEL', 'places365', 'things', 'indoor', 'sun397', 'sun397_2', 'things_plus',"miniplaces"],
    ...
    # parser.add_argument('--train_txt', default='/data/xiaomeng/dataset/places365/datasets/benjaminkz/places365/versions/1/train.txt', type=str)
    # parser.add_argument('--val_txt', default='/data/xiaomeng/dataset/places365/datasets/benjaminkz/places365/versions/1/val.txt', type=str)
    # return parser
